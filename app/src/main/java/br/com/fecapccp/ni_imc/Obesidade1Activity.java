...
public class Obesidade1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Ciclo de Vida", "Tela Obesidade1: On Create");
        ...
        String msgResultado = "Seu peso: " + String.format("%.2f", peso) + " kg" +
                ...
                "\n" + "Você está com OBESIDADE GRAU 1. Procure cuidar da saúde!";
    ...
    protected void onResume(){
        super.onResume();
        Log.i("Ciclo de Vida", "Tela Obesidade1 - onResume");
    }

    @Override
    protected void onPause(){
        super.onPause();
        Log.i("Ciclo de Vida", "Tela Obesidade1 - onPause");
    }

    @Override
    protected void onDestroy(){
        super.onDestroy();
        Log.i("Ciclo de Vida", "Tela Obesidade1 - onDestroy");
    }

    @Override
    protected void onStop(){
        super.onStop();
        Log.i("Ciclo de Vida", "Tela Obesidade1 - onStop");
    }

    @Override
    protected void onRestart(){
        super.onRestart();
        Log.i("Ciclo de Vida", "Tela Obesidade1 - onRestart");
    }

    @Override
    protected void onStart(){
        super.onStart();
        Log.i("Ciclo de Vida", "Tela Obesidade1 - onStart");
    }
}